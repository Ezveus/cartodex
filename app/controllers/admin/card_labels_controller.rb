module Admin
  ...
  class CardLabelsController < BaseController
    ...
    def card_label_params
      ...
      # And its slug, for the reason at the top of this file: the suggestion rules key on it, so a
      # rename is a delete and a create at once.
      permitted.delete(:slug) if @card_label&.role?
      permitted
    end
  end
end
