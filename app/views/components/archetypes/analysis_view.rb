module Archetypes
  # The metagame report of one archetype, one level below its deck list (Archetypes::ShowView): who it is, which sample the reader is looking at, what it
  ...
  class AnalysisView < ApplicationComponent
      ...
      div(class: "admin-container") do
        render Ui::PageHeader.new(title: @archetype.name) do
          div(class: "decks-header-actions") do
            ...
            link_to "Decks", archetype_path(@archetype), class: "btn btn-secondary"
